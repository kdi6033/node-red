...
//드라이브텍
const char *host = "a2qpy6ot038ohv-ats.iot.ap-northeast-2.amazonaws.com"; // AWS IoT Core 주소
const char* outTopic = "/jlee/outTopic"; 
const char* inTopic = "/jlee/inTopic"; 
...
String sIn="",sInPre="";  // 입력값이 달라질 때만 mqtt로 송신a
...
void crd16Rtu() {
  ...
  int si,sj,len;
  char str[24];
  //Serial.println("value of outPlc : ");
  //Serial.println(outPlc);
  if(outPlc == 1) {  //출력
